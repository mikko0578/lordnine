...
async def go_to_fot():
    ...
    pyautogui.press('=')
    time.sleep(0.5)
    dungeon = pyautogui.locateOnScreen('dungeon.png',confidence=0.9)
    if str(dungeon) != 'None':
        print('current quest count:'+str(curr_count))
        area = 'area'+str(curr_area)+'.png'
        pyautogui.click(dungeon)
        time.sleep(1)
        findAndClickSomething('fot.png')
        time.sleep(0.5)
        findAndClickSomething(area)
        time.sleep(0.5)
        if curr_area != 1:
            findAndClickSomething('enter.png')
        time.sleep(0.5)
        pyautogui.press('y')
        time.sleep(10)
        findAndClickSomething('acceptfot.png')
        time.sleep(1)
        pyautogui.press('=')
        time.sleep(1)
        findAndClickSomething('quests.png')
        time.sleep(1)
        findAndClickSomething('daily.png')
        time.sleep(1)
        findAndClickSomething('forestoftraining.png')
        time.sleep(1)
        findAndClickSomething('automove.png')
        time.sleep(0.5)
        pyautogui.press('=')
        time.sleep(1)
        findAndClickSomething('quests.png')
...
async def loopcheck():
    ...
    global curr_area
    while True:
        completed = pyautogui.locateOnScreen('obtainreward.png',confidence=0.9)
        if str(completed) != 'None':
            ...
            if curr_count == 3:
                ...
                if curr_area == 0:
                    print('FoT done')
                    break
                print('going to area '+str(curr_area))
                curr_count=1
                await go_to_fot()
                time.sleep(1)
            else:
                print('accepting another quest. Quest accepted/completed:'+str(curr_count))
                findAndClickSomething('acceptfot.png')
                time.sleep(0.5)
                pyautogui.press('=')
                time.sleep(1)
...
async def check_if_current_quest_done():
    focus_window()
    await loopcheck()
...
async def main():
    await go_to_fot()
    await loopcheck()
    # await check_if_current_quest_done()
    # while True:
    #     isDone = await check_if_current_quest_done()
    #     if isDone:
    #         print('done')
    #         break
    #     else:
